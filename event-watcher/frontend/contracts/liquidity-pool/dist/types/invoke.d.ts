 ...
 */
export declare function invoke<R extends ResponseTypes = undefined, T = string>(contractId: string, args: InvokeArgs<R, T>): Promise<R extends undefined ? T : R extends "simulated" ? Simulation : R extends "full" ? SomeRpcResponse : T>;
/**
