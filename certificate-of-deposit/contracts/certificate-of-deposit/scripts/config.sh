...
export DEFAULT_FEE=$((10 * 10**DEFAULT_DECIMAL)) # Base fee in XLM 
...
# export ASSET_ISSUER_PK="GAC2LBKUCPYFMXEFOLBWQKTLRTDGWLDMWFY7S4SDYCG3IIMGYH5DE6QB"  #The Public key of the Issuer account that controls the classic asset
# export ASSET_ISSUER_SK="SC2JNVH4VPLRFTHU7ZDGEAPIVZ3AK5PBUVBDHNQO2UIU52HHBUA4RXPK"  #The Secret key of the Issuer account that controls the classic asset
# export ASSET_CODE="FIFOZATTI"                                                      #The Asset Code.
